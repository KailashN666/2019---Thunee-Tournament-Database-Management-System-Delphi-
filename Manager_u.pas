  ...
  begin
    ...
    Begin
      ...
      Begin
        ...
        Begin
          //Manager should enter a team name until a valid one is entered, should the Team Name be incorrect
          bCheck := True;
...
begin
  ...
  begin
    //Count the amount of teams with the same score
  ...
  Begin
    ...
    //First get the highest before looking for other teams with same high score
    for I := 2 to dmTeams.tblTeams.RecordCount do
    begin
      if iHighest < dmTeams.tblTeams['TournamentsEntered'] then
      Begin
    ...
    //Gathering details of multiple teams with the same score
    Repeat
